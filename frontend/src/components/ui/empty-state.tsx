export const EmptyState = () => {
  return (
    <div className="flex flex-col items-center justify-center py-12">
      <p className="text-gray-500 mb-6">Nenhum resultado encontrado</p>
          ...
          <g transform="translate(-382.003 -195.455)">
            <g transform="translate(382.003 195.455)">
              ...
              <path
                ...
                fill="#ccc"
              />
              <circle cx="20.355" cy="20.355" r="20.355" transform="translate(121.697 319.055)" fill="#dadada" />
              <path
            ...
            <g transform="translate(673.007 225.872) rotate(-8)">
              <g transform="translate(125.896 0) rotate(19)">
                <path
                ...
                <path
                  ...
                  fill="#ccc"
                />
                <circle cx="20.355" cy="20.355" r="20.355" transform="translate(57.655 85.89)" fill="#dadada" />
                <path
                ...
                <path
                  ...
                  fill="#dadada"
                />
                <circle cx="20.355" cy="20.355" r="20.355" transform="translate(57.655 260.097)" fill="#dadada" />
                <path
            ...
            <path
              ...
              fill="#3f3d56"
            />
            <circle cx="57.007" cy="57.007" r="57.007" transform="translate(672.542 442.858) rotate(19)" fill="#dadada" />
          </g>
        </svg>
      </div>
    </div>
